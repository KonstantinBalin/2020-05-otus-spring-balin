...
insert into COMMENTS (id, book_id, comment) values (2, 1, 'Test comment');
insert into COMMENTS (id, book_id, comment) values (3, 2, 'Test comment');
insert into COMMENTS (id, book_id, comment) values (4, 2, 'Test comment');
insert into COMMENTS (id, book_id, comment) values (5, 2, 'Test comment');
